          ...
          <div className="d-flex align-items-center m-3">
            ...
            <div className={`${css.font_9} mx-3`} style={{ width: '63%' }}>
              ...
              <div className={`${css.font_8} ${css.c_green} mt-2`}>
                You get
                <strong>
                ₹{referralCommission*10000/100} Cash
                </strong>
                <strong>
                </strong>
              </div>
...
,
        .<div className='socialmediashare d-flex justify-content-center w-100'>
          ...
          <button className="refer-button cxy">
            <img src='Images/refer/whatsapp.png' style={{width:'100%'}}></img>
          </button>
          </a>
        ...
        <div className={`${css.refer_footer} pt-2 `}>
          <a href={`whatsapp://send?text=Play Ludo and earn ₹10000 daily.  ${(WebSitesettings) ? WebSitesettings.CompanyWebsite : ''}/login/${user.referral_code}  Register Now, My refer code is ${user.referral_code}.`} style={{width:"100%"}}>
          <button className="refer-button cxy">
            <img src='Images/refer/twitter.png' style={{width:'100%'}}></img>
          </button>
          </a>
        ...
        <div className={`${css.refer_footer} pt-2 `}>
          <a href={`whatsapp://send?text=Play Ludo and earn ₹10000 daily.  ${(WebSitesettings) ? WebSitesettings.CompanyWebsite : ''}/login/${user.referral_code}  Register Now, My refer code is ${user.referral_code}.`} style={{width:"100%"}}>
          <button className="refer-button cxy">
            <img src='Images/refer/copy.png' style={{width:'100%', borderRadius:'50%'}}></img>
          </button>
          </a>
