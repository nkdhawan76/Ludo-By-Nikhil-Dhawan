...
{cardData && cardData.length === 0 &&
          <div className="text-center">
            <img
              src={process.env.PUBLIC_URL + '/Images/noreferhistory.png'}
              alt="no data"
              width={300}
              height={300}
              className="img-fluid "
            ...
            <div className="mt-2">
              ...
              <h5 className="text-muted">Seems like you haven't refered any of your friend, <a href="" style={{textDecoration:'none'}}>refer now</a> to earn cash!</h5>
             </div>
          </div>
        }
      </div>
